...
# Hi, I'm Marcin! 👋😊
I'm a Java/ C# dev, focusing on Spring Boot, .NET and Quarkus, I also try to play with other frameworks and languages like TypeScript, Vue or React (some say that's library) and Golang.

I am working with AI/ML in Python, Scikit-learn, Tensor-Flow.
